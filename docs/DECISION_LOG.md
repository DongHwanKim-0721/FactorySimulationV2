...
## 2026-07-06: Input Workbook Templates Are Generated By The CLI

The planning input workbook template is generated from the same sheet/header contract used by the workbook reader. The default template includes runnable sample rows; a blank headers-only workbook can also be generated.
