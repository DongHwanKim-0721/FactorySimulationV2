...
These are active product/data, implementation-sequence, and issue-record contracts for the planning core. The #16-#22 MVP package is complete; future slices should extend this baseline rather than reopen the route/canvas prototype direction.
